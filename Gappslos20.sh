...
# Appending filter rules to the end of the gapps configuration so it strips out unneeded APKs
cat <<EOF >> vendor/gapps/config/gapps_packages.mk

# Custom filtration block to enforce your specific request list
# Strips unrequested packages from being included in PRODUCT_PACKAGES dynamically
